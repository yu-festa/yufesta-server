...
/** 응원 메시지·분실물·분실물 댓글 콘텐츠 신고 API 명세 */
@Tag(name = "Content Report", description = "응원 메시지·분실물·분실물 댓글 콘텐츠 신고 (FR-LF-04, FR-CH-03)")
@RequestMapping("/api/v1/content-reports")
@SecurityRequirement(name = "cookieAuth")
public interface ContentReportApi {

    @Operation(summary = "콘텐츠 신고", description = "로그인 사용자가 응원 메시지, 일반 분실물 게시글 또는 분실물 댓글을 신고한다. CSRF 토큰이 필요하다. FR-LF-04, FR-CH-03")
