-- ============================================================
-- YU FESTA ERD v1.7 (SRS v2.0 기준) — MySQL 8.x
...
-- v1.6: 분실물 게시글당 jpeg·png 이미지 1장 첨부·삭제(V7)
-- v1.7: 로그인 없는 서비스 오픈 Web Push 구독·예약 발송 상태(V8)
-- ============================================================
...
-- 초기 설정값 (db/migration/V2__initial_data.sql과 동일하게 유지)
...
-- 초기 라인업 (db/migration/V4__club_initial.sql과 동일하게 유지). 사진은 업로드 API 뒤에
